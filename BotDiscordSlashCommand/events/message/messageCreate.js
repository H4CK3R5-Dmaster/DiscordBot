    ...
    async execute(message, client, Discord){
        ...
        if(command.permissions){
            ...
            if (!authorPerms || !authorPerms.has(command.permissions)){
                ...
                .setColor('RED')
                .setDescription(`Tu n'as pas les perms pour cette commande`);
        ...
        if (timestamps.has(message.author.id)) {
            ...
            if (now < expirationTime) {
                ...
                .setColor('RED')
                .setDescription(`Vous devez attendre ${timeLeft.toFixed(1)}s avant d'utiliser la commande à nouveau !`)
